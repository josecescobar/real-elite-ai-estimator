...
- [ ] **Fix the 2 lint warnings.** Unused `bgColor` (`estimates/DescriptionScore.tsx:57`) and unused `numberPattern` (`lib/description-scoring.ts:18`).
